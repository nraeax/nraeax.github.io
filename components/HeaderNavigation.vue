...
<template>
	...
	>
		...
		<NuxtLink to="/contact" class="text-sm font-medium" activeClass="text-green-500">Contact</NuxtLink>
	</nav>
	<button @click="showMenu = !showMenu" class="w-6 h-6 flex items-center justify-center md:hidden">
