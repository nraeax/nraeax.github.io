...
class UtfString {
  constructor(str) {
    __publicField$2(this, "utf16Length");
    __publicField$2(this, "utf8Length");
    __publicField$2(this, "utf16Value");
    __publicField$2(this, "utf8Value");
    __publicField$2(this, "utf16OffsetToUtf8");
    __publicField$2(this, "utf8OffsetToUtf16");
...
const _OnigString = class _OnigString {
  constructor(str) {
    __publicField$2(this, "id", ++_OnigString.LAST_ID);
    __publicField$2(this, "_onigBinding");
    __publicField$2(this, "content");
    __publicField$2(this, "utf16Length");
    __publicField$2(this, "utf8Length");
    __publicField$2(this, "utf16OffsetToUtf8");
    __publicField$2(this, "utf8OffsetToUtf16");
    __publicField$2(this, "ptr");
    if (!onigBinding)
...
__publicField$2(_OnigString, "LAST_ID", 0);
__publicField$2(_OnigString, "_sharedPtr", 0);
// a pointer to a string of 10000 bytes
__publicField$2(_OnigString, "_sharedPtrInUse", false);
let OnigString = _OnigString;
class OnigScanner {
  constructor(patterns) {
    __publicField$2(this, "_onigBinding");
    __publicField$2(this, "_ptr");
    if (!onigBinding)
      throw new Error("Must invoke loadWasm first.");
    const strPtrsArr = [];
    const strLenArr = [];
...
class Registry extends mainExports.Registry {
  constructor(_resolver, _themes, _langs) {
    ...
    this._langs = _langs;
    __publicField$1(this, "themesPath", "themes/");
    __publicField$1(this, "_resolvedThemes", {});
    __publicField$1(this, "_resolvedGrammars", {});
    __publicField$1(this, "_langMap", {});
...
class Resolver {
  constructor(onigLibPromise, onigLibName, langs) {
    __publicField(this, "languageMap", {});
    __publicField(this, "scopeToLangMap", {});
    __publicField(this, "_onigLibPromise");
    __publicField(this, "_onigLibName");
