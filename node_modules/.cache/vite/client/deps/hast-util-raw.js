...
// node_modules/hast-util-raw/node_modules/unist-util-position/lib/index.js
...
// node_modules/hast-util-raw/node_modules/unist-util-visit-parents/lib/color.browser.js
function color(d) {
  return d;
}
      ...
      if (location2.attrs) {
        for (key in location2.attrs) {
          if (own3.call(location2.attrs, key)) {
            props[find(state.schema, key).property] = position2(
              location2.attrs[key]
            );
          }
        }
